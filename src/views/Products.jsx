...
const Products = () => {
  return (
    <div
      id="products"
      className="flex flex-col 2xl:flex-row gap-[128px] 2xl:gap-2 2xl:justify-between mt-[160px] 2xl:mt-[270px] mb-[160px] container mx-auto px-10 w-full"
    >
      ...
      <div className="w-full flex flex-col md:flex-row gap-[160px] md:gap-6">
        {products.map((product, i) => (
          <FadeIn key={i} delay={i + 1} direction="left" fullWidth>
            <div className="h-[450px] relative z-0 flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
              <img
                src={product.img}
                alt=""
                className="absolute z-10 -top-[120px] left-1/2 -translate-x-1/2"
              />
              <div className="absolute z-20 bottom-0 w-full bg-white h-[260px] rounded-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between">
                <div>
